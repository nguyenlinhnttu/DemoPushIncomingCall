    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        try {
            ...
            notificationBuilder = NotificationCompat.Builder(
                ...
                .setSound(Uri.parse("android.resource://" + application.packageName + "/" + R.raw.voip_ringtone))
            ...
            if (!isScreenOn) {
                pm.newWakeLock(PowerManager.FULL_WAKE_LOCK or PowerManager.ACQUIRE_CAUSES_WAKEUP or PowerManager.ON_AFTER_RELEASE, "MyLock")
                    .acquire(10000)
    ...
    */
    fun createChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setSound(
                Uri.parse("android.resource://" + application.packageName + "/" + R.raw.voip_ringtone),
